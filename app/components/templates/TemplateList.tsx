...
//                 size={30}
//                 name={item?.attribute?.icon_name ? item?.attribute?.icon_name : "sticky-note-o"}
//               />
//             </Button>
          ...
          <Card.Actions style={styles.cardActions}>
            <Button>
              <Icon
                style={styles.styleicon}
                size={30}
                name={isValidIconName(item?.attribute?.icon_name) ? item?.attribute?.icon_name : "sticky-note-o"}
              />
            </Button>
